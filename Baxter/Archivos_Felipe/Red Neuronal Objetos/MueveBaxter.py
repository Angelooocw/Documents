...
class Mueve:
	...
	def randomm(self): 
        ...
        def CA(self,objectX,objectY,Herramienta):
                ...
                (a,b) = self.pixel_to_baxter([self.cx,self.cy],0.22) #0.17

                self.mover_baxter('base',[a,b,self.pose[2]],[self.pose[3],self.pose[4],self.pose[5]])
		
	        self.mover_baxter('base',[a, b, self.pose[2] - 0.2],[self.pose[3], self.pose[4], self.pose[5]])
	        ...
	        if self.gripper.force() != 0:
	                ...
	                if Herramienta == 'Celulares':
	                        print 'Moviendo Celular'
	                        self.mover_baxter('base',[self.Contenedor_1[0],self.Contenedor_1[1],self.pose[2]],self.pose[3:6])
				self.mover_baxter('base',[self.Contenedor_1[0],self.Contenedor_1[1],self.pose[2]- 0.15],self.pose[3:6])
				self.gripper.open()
	                        self.mover_baxter('base',[self.Contenedor_1[0],self.Contenedor_1[1],self.pose[2]],self.pose[3:6])
