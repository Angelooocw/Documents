...
class Mueve:
	...
	def randomm(self):
        ...
        def CA(self,objectX,objectY,KMean,Angulo,Dimension):
		...
		if (Dimension[0] < Dimension[1]) and (Angulo == -90 or Angulo == -0):
	        ...
	        self.mover_baxter('base',[a, b, self.pose[2] - 0.18],[self.pose[3], self.pose[4], self.pose[5]+self.angulo])
